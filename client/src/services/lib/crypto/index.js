...
/**
 * Encrypts data using a SEA key pair.
 *
 * @param {string} data - The data to encrypt
 * @param {object} pair - The SEA key pair to use for encryption
...
/**
 * Decrypts data using a SEA key pair.
 *
 * @param {string} data - The encrypted data to decrypt
 * @param {object} pair - The SEA key pair to use for decryption
