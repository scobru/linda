// Shared frame codec for the RN <-> Bare worklet bridge (see mobile/src/bare/client.ts and
// mobile/worklet/entry.ts). Frame layout (both directions): <4-byte LE header length><JSON header bytes><binary tail>.
import b4a from 'b4a'
